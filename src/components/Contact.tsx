      ...
      <div className="container" style={{ position: 'relative', zIndex: 1 }}>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8rem', alignItems: 'center' }} className="contact-grid">
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
              <div>
                ...
                <a href="mailto:hello@studiopulse.com" className="hover-target" style={{ color: 'white', textDecoration: 'none', fontSize: '1.5rem', fontWeight: 500, display: 'inline-flex', alignItems: 'center', gap: '0.5rem' }}>
                  hello@studiopulse.com <ArrowRight size={20} className="text-gradient-accent" />
                </a>
              </div>
              <div>
          ...
          >
            ...
            <FloatingInput label="Company / Organization" />
